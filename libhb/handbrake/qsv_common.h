...
hb_buffer_t * hb_qsv_copy_video_buffer_to_hw_video_buffer(const hb_job_t *job, const hb_buffer_t *in, const int is_vpp);
hb_buffer_t * hb_qsv_buffer_dup(const hb_job_t *job, const hb_buffer_t *in, const int is_vpp);
hb_buffer_t * hb_qsv_copy_avframe_to_video_buffer(const hb_job_t *job, const AVFrame *frame, AVRational time_base, const int is_vpp);
